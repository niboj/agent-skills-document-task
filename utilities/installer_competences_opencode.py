...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Install repository skills into an OpenCode-compatible global skills directory."
    )
    parser.add_argument("--skills-root", default="skills", help="Source skills directory")
    parser.add_argument(
        "--target-dir",
        default="~/.config/opencode/skills",
        help="Destination directory. Defaults to ~/.config/opencode/skills",
    )
